...
>
> Also, we think we should go live/public with this when it is ready—to show folks you are iterating on the site, that it is tangibly improving, and to “sand down” the abrupt edge of a complete overhaul.
